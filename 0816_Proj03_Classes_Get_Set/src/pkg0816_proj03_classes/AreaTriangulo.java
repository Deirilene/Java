...
public class AreaTriangulo {
    ...
    public static void main(String[] args) {
        ...
        triangulo.setAltura(Integer.parseInt(JOptionPane.showInputDialog(null,"Digite o valor da altura: ","Área do triângulo ",JOptionPane.QUESTION_MESSAGE)));
        triangulo.setBase(Integer.parseInt(JOptionPane.showInputDialog(null,"Digite o valor da base: ","Área do triângulo ",JOptionPane.QUESTION_MESSAGE)));
